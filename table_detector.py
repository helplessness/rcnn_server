...
class FasterRCNN:
    ...
    def load_model(self):
        checkpoint_path = '././models/faster_rcnn.pth'
        ...
        self.im_data = self.im_data.cpu()
        self.im_info = self.im_info.cpu()
        self.num_boxes = self.num_boxes.cpu()
        self.gt_boxes = self.gt_boxes.cpu()
        self.model.cpu()
    ...
    def detect(self, img_data):
        ...
        box_deltas = box_deltas.view(-1, 4) * torch.FloatTensor(cfg.TRAIN.BBOX_NORMALIZE_STDS).cpu() \
